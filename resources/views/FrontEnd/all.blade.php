                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="count-job mb-35">
                                    <span>{{ count($pekerjaan) }} Jobs found</span>
                                    <!-- Select job items start -->
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                <div class="company-img">
                                    <a href="#"><img src="{{ asset('pekerjaan/'.$item->gambar) }}" alt="" width="125" height="125"></a>
                                </div>
                            ...
                            <div class="items-link items-link2 f-right">
                                <a href="job_details.html">{{ $item->kategori->nama_kategori }}</a>
